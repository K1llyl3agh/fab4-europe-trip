...
HEATHROW_TRANSFER_QR_B64 = ''
WALK_ROUTES = [
...
DINNER_12SEP = [
    {'place': 'Ai Tre Scalini - Bottiglieria dal 1895', 'type': 'Historic Monti wine bar (since 1895) - great wines by the glass, traditional small plates, lively atmosphere',
     'address': 'Via Panisperna 251, Monti - ~15 min walk', 'website': 'https://www.aitrescalini.org/',
    ...
    {'place': 'La Carbonara', 'type': 'Rome institution since 1906, famous for its namesake dish - carbonara, amatriciana, cacio e pepe',
     'address': 'Via Panisperna 214, Monti - ~15 min walk', 'website': 'https://www.lacarbonara.it/',
     'hours': 'Mon-Sat 12:30-2:30pm & 7-11pm (closed Sun)',
    ...
    {'place': 'Al Vino al Vino', 'type': 'Intimate Monti enoteca (since 1999) - excellent wine list by the glass, sweet-and-sour eggplant caponata',
     'address': 'Via dei Serpenti 19, Monti - ~14 min walk', 'website': 'http://www.colosseo.org/alvinoalvino/',
    ...
    {'place': 'La Taverna dei Monti', 'type': 'Popular traditional trattoria - carbonara, cacio e pepe and other Roman staples done well',
     'address': 'Via del Boschetto 41, Monti - ~15 min walk', 'website': 'https://www.thefork.it/ristorante/la-taverna-dei-monti-r812376',
     'hours': 'Tue-Sun 12:30pm-11pm (closed Mon)',
    ...
    {'place': 'Taverna Romana', 'type': 'Popular family-run local spot known for authentic Roman cuisine and reasonable prices - book ahead as it fills fast',
     'address': 'Via della Madonna dei Monti 79, Monti - ~14 min walk', 'website': 'https://www.thefork.it/ristorante/taberna-romana-r843943',
...
def gala_day_box_html(theme, sea_note):
    return f'''
<div class="red-callout gala-day-box">
  <div class="red-callout-title">&#127881; Tonight is a Gala Evening &ndash; {theme}</div>
  <p>Formal dress code on board tonight{sea_note}. See the Gala Evenings box in the Queen Victoria Cruise overview above for the full confirmed schedule.</p>
</div>'''

GALA_DAY_BOXES = {
    'DAY 15': gala_day_box_html('Red and Gold', ' (a sea day, so plenty of time to get ready)'),
...
<div class="email-sent-box">
  <div class="email-sent-title">&#9989; Transfer to Heathrow CONFIRMED &ndash; Booking Ref 58793 (Euro Cars London)</div>
  <div class="email-sent-meta"><strong>From:</strong> Sofia Urruty, Junior Concierge &ndash; The Level at Meli&aacute; White House &middot; <strong>Subject:</strong> RE: Transfer to Heathrow &middot; <strong>Received:</strong> 2 Sept 2026, 8:56am</div>
  <p>Private transfer for our party of 4 with luggage booked through <strong>Euro Cars London</strong> (booking ref <strong>58793</strong>) &ndash; a Mercedes V Class, pickup <strong>6:00pm</strong> from Meli&aacute; White House for our 10:00pm BA15 departure from Heathrow T5. Fare <strong>&pound;135</strong> (cash/card). Driver contact: +44 207 724 9990.</p>
  <p>Gary's mobile has been sent through to the concierge as requested &ndash; nothing further to do. Full confirmation PDF is in <a href="#traveldocuments">Travel Documents</a>.</p>
</div>'''
...
.hero-photo img { width:220px; height:220px; object-fit:cover; border-radius:50%; border:5px solid #fff; box-shadow:0 8px 30px rgba(31,56,100,.3); }
...
.hero-nav a { display:inline-flex; align-items:center; gap:7px; text-decoration:none; font-weight:600; color:var(--navy); font-size:.88rem; background:rgba(31,56,100,.08); border:1px solid rgba(31,56,100,.3); padding:9px 18px; border-radius:999px; transition:background .15s; }
.hero-nav a:hover { background:rgba(31,56,100,.18); }
...
.nav-col a { display:inline-flex; align-items:center; gap:7px; text-decoration:none; font-weight:600; color:var(--navy); font-size:.88rem; background:rgba(31,56,100,.08); border:1px solid rgba(31,56,100,.3); padding:9px 18px; border-radius:4px 4px 0 0; transition:background .15s; width:100%; justify-content:center; box-sizing:border-box; }
.nav-col a:hover { background:rgba(31,56,100,.18); }
...
table.flight-table tr.flight-retimed td { background:#fff6e0 !important; color:#8a6400; font-weight:600; }
...
.flight-retimed-tag { display:inline-block; background:#b9840c; color:#fff; font-size:.65rem; font-weight:700; letter-spacing:.02em; text-decoration:none; border-radius:4px; padding:1px 6px; margin-left:6px; vertical-align:middle; }
@media print {
...
.home-fab { display:inline-flex; align-items:center; gap:8px; background:rgba(31,56,100,.08); border:1px solid rgba(31,56,100,.3); color:var(--navy) !important; text-decoration:none; font-size:1.05rem; font-weight:700; padding:12px 22px; border-radius:999px; box-shadow:0 2px 10px rgba(31,56,100,.12); transition:background .15s; }
.home-fab:hover { background:rgba(31,56,100,.18); }
...
.hero .print-mini { background:rgba(31,56,100,.08); border:1px solid rgba(31,56,100,.3); color:var(--navy); }
.hero .print-mini:hover { background:rgba(31,56,100,.18); }
.hero .print-mini-all { background:var(--gold); border-color:var(--gold); color:#fff; }
...
''' + '\n'.join(
  ...
  /* Print Milan: show restaurant/event photos (normally stripped on print)
     and tune page breaks so nothing splits mid-card or leaves an orphaned
     heading - covers the base day, Options A/B/C and the dinner list. */
  body.printing-milan .resto-list { display:flex !important; flex-direction:column !important; gap:14px !important; }
  body.printing-milan .resto-item { display:flex !important; align-items:flex-start !important; page-break-inside:avoid !important; break-inside:avoid !important; }
  body.printing-milan .resto-photo, body.printing-milan .ev-photo, body.printing-milan .place-photo, body.printing-milan .place-photo-btn { display:block !important; }
...
FLIGHTS = [
    ('Thu 10 Sept', 'QF162', 'Qantas', 'T1 &rarr; T1', 'Wellington (WLG) &rarr; Sydney (SYD)', '6:05am &rarr; 7:39am', 'Business', '3h 34m', 'gk', '40kg'),                                                    #0
    ('Thu 10 Sept', 'QF1', 'Qantas', 'T1 &rarr; T1', 'Sydney (SYD) &rarr; Singapore (SIN)', '8:00pm &rarr; 2:30am +1', 'Premium Economy', '8h 30m', 'all', '40kg'),                                              #1 REBOOKED (time changed)
...
for _i, (date, flight, airline, terminals, route, times, cabin, dur, who, bag) in enumerate(FLIGHTS):
    ...
    _status = FLIGHT_ROW_STATUS.get(_i)
    _status_class = f' flight-{_status}' if _status else ''
    _tag_html = {
        'superseded': '<span class="flight-superseded-tag">CANCELLED &ndash; rebooked</span>',
        'rebooked': '<span class="flight-rebooked-tag">NEW</span>',
        'retimed': '<span class="flight-retimed-tag">TIME CHANGED</span>',
    }.get(_status, '')
    _flight_label = f'{flight} {_tag_html}' if _tag_html else flight
...
<section id="traveldocuments" class="print-block" data-section="traveldocuments">
  ...
  <div class="td-grid">
    ...
    <div class="td-row">
      <a class="pill pill-weblink td-btn" href="fab4-heathrow-transfer-confirmation.pdf" target="_blank">Heathrow Transfer Confirmation</a>
      <img class="td-qr" src="data:image/png;base64,{HEATHROW_TRANSFER_QR_B64}" alt="QR code to Heathrow Transfer Confirmation">
    </div>
  </div>
